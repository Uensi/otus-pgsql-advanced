...
#### 4.1 В директории Terraform создаем файлы (locals.tf, main.tf, outputs.tf, providers.tf, variables.tf, terraform.tfvars) --> (по умолчанию C:\Terraform)
