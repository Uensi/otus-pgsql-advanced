...
Данные генерировались **определенным** способом (все поля чистые функции от `event_id`, без ГСЧ), поэтому на обеих ВМ были сгенерированы **побайтово одинаковые** CSV-файлы. Контроль: `count(*)` в обеих СУБД совпал 100 000 000 событий и 1 000 000 пользователей.
