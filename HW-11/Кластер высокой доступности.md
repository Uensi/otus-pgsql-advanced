...
| `ha-pg-03` | `ru-central1-a` | 10.1.2.32 |

Нечётное число нод (3) обеспечивает кворум etcd при падении одной ноды/зоны.
...
| Параметр | Значение |
|---|---|
| Облако / зоны | Yandex Cloud, `ru-central1-a`, `ru-central1-b` |
